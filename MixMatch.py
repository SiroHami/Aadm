...
def main():
    ...
    transform_labeled_train=dataset.cifar10_labeled_train_transform

    transform_unlabeled_train=dataset.cifar10_labeled_train_transform

    transform_val = dataset.cifar10_labeled_train_transform

    train_labeled_set, train_unlabeled_set, val_set, test_set = dataset.get_cifar10('./data', args.n_labeled, transform_labeled_train=transform_labeled_train, 
